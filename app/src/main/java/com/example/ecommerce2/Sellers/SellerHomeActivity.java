...
import com.example.ecommerce2.Model.Products;
import com.example.ecommerce2.R;
import com.example.ecommerce2.ViewHolder.ItemViewHolder;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.navigation_home:
                    Intent intentHome = new Intent(SellerHomeActivity.this, HomeActivity.class);
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(unverifiedProductsRef.orderByChild("productState").equalTo(FirebaseAuth.getInstance().getCurrentUser().getUid()), Products.class)
                        .build();
        ...
        FirebaseRecyclerAdapter<Products, ItemViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ItemViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ItemViewHolder holder, int position, @NonNull Products model)
                    {
                        ...
                        Picasso.get().load(model.getImage()).into((ImageView) holder.imageView);
